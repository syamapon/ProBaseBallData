...
members1516 = pd.merge(dfMember2015, dfMember2016, left_index=True, right_index=True, how='outer', suffixes=('_2015', '_2016'))
members = pd.merge(members1920, members1718, left_index=True, right_index=True, how='outer')
members = pd.merge(members1516, members, left_index=True, right_index=True, how='outer')

members100over = members [members['試合_2020'] > 80][members['試合_2019'] > 80][members['試合_2018'] > 80][members['試合_2017'] > 80][members['試合_2016'] > 80][members['試合_2015'] > 80]
print(members100over.loc[:, ['試合_2015', '試合_2016', '試合_2017', '試合_2018', '試合_2019', '試合_2020']])
...
print(dfMembers100Over.loc[:, [('2020', '試合'), ('2019', '試合'), ('2018', '試合')]])
